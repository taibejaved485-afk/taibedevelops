...
const Hero: React.FC = () => {
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between text-left py-20 min-h-[90vh] mt-10 gap-12 lg:gap-20">
      {/* Left Side: Content */}
      <div className="flex-1 order-2 lg:order-1 space-y-8 max-w-2xl">
        <div className="space-y-4">
          <p className="font-futuristic text-cyan-400 tracking-[0.4em] text-sm uppercase animate-pulse">
            Protocol: Active
          </p>
          <h1 className="text-6xl md:text-8xl lg:text-9xl font-black tracking-tighter metallic-text uppercase leading-none">
            Taibe <br /> Javed
          </h1>
          <div className="h-1 w-32 bg-gradient-to-r from-cyan-400 to-transparent rounded-full"></div>
        </div>

        <p className="font-futuristic text-xl md:text-2xl text-gray-300 tracking-[0.2em] uppercase min-h-[3rem]">
        ...
        <div className="flex flex-wrap gap-6 pt-4">
          <a 
            href="#projects" 
            className="px-10 py-4 rounded-full animated-border font-futuristic text-[10px] tracking-[0.3em] hover:scale-110 transition-transform active:scale-95 shadow-[0_0_20px_rgba(34,211,238,0.2)]"
          >
            EXPLORE WORK
          </a>
          <a 
            href="#contact" 
            className="px-10 py-4 rounded-full border border-white/10 glass-card font-futuristic text-[10px] tracking-[0.3em] hover:border-cyan-500 hover:scale-110 transition-all active:scale-95"
          >
            INITIATE CONTACT
          </a>
        </div>
      ...
      <div className="flex-1 order-1 lg:order-2 flex justify-center lg:justify-end">
        <div className="relative group">
          ...
          <div className="absolute -inset-12 bg-gradient-to-tr from-cyan-500/30 via-purple-500/20 to-pink-500/30 blur-[100px] rounded-full opacity-60 animate-pulse"></div>
          ...
          {/* Circle Frame */}
          <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-[450px] lg:h-[450px] rounded-full p-2 bg-gradient-to-tr from-cyan-400/50 via-purple-500/30 to-pink-500/50 shadow-[0_0_50px_rgba(34,211,238,0.3)] group-hover:shadow-[0_0_80px_rgba(34,211,238,0.5)] transition-all duration-700">
