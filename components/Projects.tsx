      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 auto-rows-[350px]">
        {projects.map((project, idx) => (
          <div 
            ...
            className={`group glass-card rounded-3xl overflow-hidden relative border border-white/5 shine-sweep transition-transform duration-300 ease-out will-change-transform ${project.span}`}
          >
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-end z-10">
              <h3 className="text-2xl font-bold mb-3 group-hover:text-cyan-400 transition-colors uppercase tracking-tight">
                {project.title}
              </h3>
              <p className="text-gray-400 text-[11px] leading-relaxed mb-8 line-clamp-2 font-light">
                {project.desc}
              </p>
              ...
              <a 
                ...
                className="w-max px-8 py-3 rounded-full border border-cyan-500/20 text-[9px] font-futuristic tracking-[0.3em] text-cyan-400 transition-all flex items-center gap-3 hover:bg-cyan-500 hover:text-black hover:shadow-[0_0_30px_rgba(34,211,238,0.6)] group-hover:border-cyan-400"
              >
            ...
            <div className="absolute top-0 right-0 w-16 h-16 pointer-events-none border-t border-r border-white/10 rounded-tr-3xl transition-all group-hover:border-cyan-500/40"></div>
          </div>
        ))}
      </div>
    </div>
